...
/* package xmonad-chell-config-0.1.0.0 */
#ifndef VERSION_xmonad_chell_config
#define VERSION_xmonad_chell_config "0.1.0.0"
#endif /* VERSION_xmonad_chell_config */
#ifndef MIN_VERSION_xmonad_chell_config
#define MIN_VERSION_xmonad_chell_config(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_xmonad_chell_config */
...
#define CURRENT_COMPONENT_ID "xmonad-chell-config-0.1.0.0-inplace-xmonad-chell-config"
